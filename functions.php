...
// Add yours here following the below format
    ...
    wp_register_style( 'featherlight',  get_template_directory_uri() . '/css/featherlight.css', false, false, 'all' );
    wp_enqueue_style( 'featherlight',  get_template_directory_uri() . '/css/featherlight.css', false, false, 'all' );
